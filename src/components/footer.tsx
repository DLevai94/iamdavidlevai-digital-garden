          ...
          <div className="flex flex-col justify-center space-y-8">
            ...
            >
              <div className="flex flex-col w-full mx-auto space-y-5 md:space-y-0 md:space-x-5 md:flex-row">
                <input
                  type="email"
                  className="revue-form-field flex-1 w-full px-5 py-5 text-2xl bg-gray-200 border border-gray-300 rounded-lg focus:ring-4 focus:ring-blue-600 focus:ring-opacity-50 focus:outline-none"
                ...
                <input
                  type="submit"
                  className="flex-shrink-0 px-10 py-5 text-2xl font-medium text-center text-gray-900 bg-yellow-400 rounded-lg focus:ring-4 focus:ring-yellow-600 focus:ring-opacity-50 focus:outline-none"
                  value="I want in!"
